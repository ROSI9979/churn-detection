    ...
    <div className="min-h-screen bg-slate-50 p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Real-time churn detection and retention analytics</p>
        </div>
              ...
              .map((customer: any, idx: number) => (
                <div key={customer.customer_id} className="flex justify-between items-center pb-2 border-b">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-sm text-gray-600">Risk: {customer.churn_risk_score.toFixed(0)}</p>
                  </div>
                </div>
              ))}
          </div>
